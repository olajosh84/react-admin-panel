...
const Navbar = ({ setShowSidebar }) => {
    ...
    return (
        <>
            ...
            {showModals.languageModal && <div className="lang-modal">
                           ...
                           languages.map(item => {
                                ...
                                return (
                                    <div className="lang-container">
                                        <div className="lang" key={id} onClick={getLanguage}>
                                            {name}
                                        </div>
                                    </div>
                                )
            ...
            {showModals.notificationModal && <div className="notification-popup">
            ...
            {showModals.messageModal && <div className="messages-popup">
           ...
           {showModals.searchModal && <div className="search-popup">
